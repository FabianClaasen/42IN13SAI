...
int main(int argc, const char * argv[])
{
	...
	compile2.push_back(new CompilerNode("$value", "3", false));
    compile2.push_back(new CompilerNode("$value", "7", false));
    
    std::vector<CompilerNode*> compile;
    compile.push_back(new CompilerNode("$value", "3", false));
    compile.push_back(new CompilerNode("$add", compile2, nullptr, false));
    nodes.push_back(*new CompilerNode("$less", compile2, nullptr, false));
